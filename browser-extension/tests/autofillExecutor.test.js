...
assert(src.includes("f.fieldKey || f.intent"), "filters by stable field key");
...
assert(src.includes("label:"), "maps label");
assert(src.includes("position:"), "maps field position");
assert(src.includes("radios:"), "maps radio group choices");
